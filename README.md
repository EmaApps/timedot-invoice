...
The generated HTML site can be previewed here: https://srid.github.io/amb/
...
- As a first step to using this template, 
  - change the project name in .cabal, flake.nix and hie.yaml files; then commit changes to Git.
      - To automate this, `mv amb.cabal myproject.cabal; nix run nixpkgs#sd -- amb myproject * */* .github/*/*`
- Configuration:
